...
class AerialSensitivityAnalyzer:
    def __init__(self, parameters, animations_dir="../animations"):
        ...
        Path(self.animations_dir).mkdir(parents=True, exist_ok=True)
    ...
    def default_base_lam():
        return  [ 6.93e1,  0.0 , 1.751e2 ,-1.192e1, 4.29e-3,  1.83e-1 , 2.159e-2 , 6.921e-1, 8.21,  4.878e1 , 4.85e+1 , 1.5207e3]
